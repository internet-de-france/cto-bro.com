...
The offer:
  ...
  - |-
    ...
    CTO Bro is live chat with experienced lead devs and CTOs. Choose your coach and take stock twice a week. 
  ...
  - |-
    ...
    Our best mentors respond 24 hours a day. Ask a question and get the answer in minutes, or a day at most. 
    
    All coaches are passionate about development, growth management, leadership ... When, in the chat, a pop question, then the discussion is open and the opinions expressed are confronted with the service of your product. 
    
    ![CTO Bro team](uploads/team2.png)
  - |-
    ## As a team, your leads and us 
    
    For teams already structured, we offer a dedicated chat room that allows your "lead dev" and architects to discuss freely with our network of experts. 
...
Value Proposition:
  ...
  The digital world is changing fast - technology,
    ...
    linked to the ability to evolve rapidly. 
  ...
  We recruit for you CTOs and lead devs referent in their
    fields. They are not consultants, they are mentors. 
...
The solution:
  ...
  - |-
    ...
    We choose with you the ultimate expertise in your field, for useful information and contacts immediately and concretely. 
  ...
  - |-
    ...
    All your questions will find an answer, quickly and without limit of the number of question or complexity. The "bro" are there to be challenged! 
...
Testimonials:
  ...
  - |-
    ...
    > What I most appreciated is to be able to ask very specific questions about my real situations and to obtain concrete solutions as well as recommendations on the most appropriate tools and resources. 
    
    Jean-Baptiste Richardet, CTO @ cameo
  - |-
    ![Christophe.jpg](uploads/christophe.jpg) 
    
    > Great mentors go beyond questions, they inspire. CTO Bro is a solution that provides both mentors and mentors with connections and skills development. 
...
Pricing:
  Text: |-
    ...
    Do not hesitate to contact us (mailto: sales@cto-bro.com) for more information. The prices below are exclusive of VAT (VAT not included). 
    
  Body:
  - Title: Founder
    Text: "<div class=\"price\"><div class=\"value\"> 2299 </div> €/month </div>
  ...
  - Title: investors
    Text: "<div class=\"price\"><div class=\"value\"> 299 </div> €/h </div>
...
How it works:
  ...
  The \"one to one\" chat experience allows us to address
    ...
    of modern companies. This has many advantages: 
...
The team:
  ...
  - "![alex hoyau cto](uploads/alex.jpg) 
    ...
    I founded in 2010 to bring diversity to tech companies. 
    ...
    CI and Industrial Workflows, Recruitment, Leadership 
  ...
  - "![Xavier Hausherr CTO](uploads/xavier.jpg) 
    ...
    of millions of users every month. 
...
Audience:
  ...
  - Text: |-
      ...
      Our experience and our "founder" offer allow us to respond in a very personal way to the CTO creators of startups. 
      
      It is difficult to embark on the dev of a new product, to set up a road map, to define an MVP, to innovate, to recruit, to industrialize and to evolve a basic code. For this we have techniques from our failures and our most glorious moments. 
      
      Contact us to get started on the adventure or try CTO Bro for free. 
      
    Call To Action: 
  - Text: |-
      ### dev teams, innovation department 
      
      As experienced CTOs and Leads we can help you think "out of the box", streamline your organization and develop your products. 
      ...
      Contact us to set a suitable quote or get started on the adventure and test CTO Bro for free. 
  ...
  CTO Bro gives you access to an extremely
      ...
      * Long-term support, coaching type, technical teams of
      ...
      Contact us to create an estimate adapted to your needs. 
      "
    Call To Action: Contact Founders EN
  - Text: |-
      ### CTOs, join us! 
      ...
      Remember your beginnings, what happiness if you had a special relationship with a profile like yours today. What impact would that have had on your motivation, on your projects? 
      
      In addition to your current work, invest in new innovative projects. Have a real impact on your ecosystem. Join our community of recognized part-time experts, and make many exciting contacts. 
      
      Your time is precious and we make every effort to ensure that your interventions are as effective as possible. All exchanges are done in writing from your desktop or mobile at the time that suits you. 
      
      The hiring process takes 4 hours, which allows us to understand who you are and which project will suit you best. And the pay is substantial, although it's probably not your priority today. 
