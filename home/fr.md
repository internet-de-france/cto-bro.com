...
How it works:
  ...
  - "### 100% live chat\n\nL’expérience de chat en “one to one” nous permet d’adresser
    ...
    des échanges, recherche d’infos dans l’historique, monitoring possible de l’activité
    pour détecter un éventuel dysfonctionnement et suivi de la facturation\n* Une
